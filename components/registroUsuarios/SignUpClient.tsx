...
import { MailOutlined, LockOutlined, UserOutlined } from "@ant-design/icons"; // Importar el icono de usuario
      ...
      <div className="w-1/2 flex p-1">
        <div className="w-full sm:max-w-2xl lg:w-[450px] bg-white dark:bg-gray-900 p-8 rounded-[12px] shadow-md border border-gray-200">
          ...
          <form className="flex flex-col gap-1">
            {/* Campo Nombre */}
            <label htmlFor="nombre" className="mt-4 text-gray-700 dark:text-gray-300">Nombre</label>
            <div className="relative">
              <UserOutlined className="absolute left-4 top-3 text-gray-500 dark:text-gray-400" />
              <Input
                name="nombre"
                autoComplete="off"
                placeholder="Nombre"
