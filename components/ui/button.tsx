  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-gray-300 bg-transparent text-gray-700 hover:bg-blue-300 focus:ring-gray-400",
        secondary:
          "bg-gray-700 text-white hover:bg-gray-600 focus:ring-gray-500 hover:bg-gray-100",
        ghost:
          "text-gray-700 hover:bg-gray-300 focus:ring-gray-300",
